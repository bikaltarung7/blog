                        ...
                        <div class="padding-10">
                            ...
                            <div class="post-meta no-border">
                                <ul class="post-meta-group">
                                    <li><i class="fa fa-user"></i><a href="{{ route('post.author',$post->author->name )}}">{{ $post->author->name }}</a></li>
                                    <li><i class="fa fa-clock-o"></i><time>{{ $post->created_at->diffForHumans() }}</time></li>
                                    <li><i class="fa fa-tags"></i><a href="{{ route('post.category',$post->category->slug)}}">{{ $post->category->title}}</a></li>
                ...
                <article class="post-author padding-10">
                    <div class="media">
                      ...
                      <div class="media-body">
                        <h4 class="media-heading"><a href="{{ route('post.author',$post->author->name )}}">{{ $post->author->name }}</a></h4>
